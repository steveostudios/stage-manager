$(document).ready(function () {
  ...
  $(document).on('click', '.rowSave', function(e) {
    ...
    if(id == null) {
      ...
      socket.emit('segmentCreate', {eventId: '50bab2c958182a54a3000002', rowTitle: title, rowTrt: trt}, function (data) {
  ...
  $(document).on('click', 'div#segments ul.body li.segment div.segment div.title', function(e) {
    ...
    socket.emit('segmentCurrent', {eventId: '50bab2c958182a54a3000002', rowId: id});
  });
